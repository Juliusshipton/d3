...
class ODMR(ManagedJob, GetSetItemsMixin):
    ...
    traits_view = View(VGroup(HGroup(Item('submit_button', show_label=False, springy=True),
                              ...
                              VGroup(HGroup(Item('power', enabled_when='state != "run"', springy=True),
                                            Item('frequency_begin', enabled_when='state != "run"', springy=True),
                                            Item('frequency_end', enabled_when='state != "run"', springy=True),
                                            Item('frequency_delta', enabled_when='state != "run"', springy=True),
                                            ),
                                     HGroup(Item('pulsed', enabled_when='state != "run"', springy=True),
                                            Item('power_p', enabled_when='state != "run"', springy=True),
                                            Item('frequency_begin_p', enabled_when='state != "run"', springy=True),
                                            Item('frequency_end_p', enabled_when='state != "run"', springy=True),
                                            Item('frequency_delta_p', enabled_when='state != "run"', springy=True),
                                            Item('t_pi', enabled_when='state != "run"', springy=True),
                                            ),
                                     HGroup(Item('seconds_per_point', enabled_when='state != "run"', springy=True),
                                            Item('laser', enabled_when='state != "run"', springy=True),
                                            Item('wait', enabled_when='state != "run"', springy=True),
                                            ),
                                     HGroup(Item('perform_fit', springy=True),
                                            Item('number_of_resonances', springy=True),
                                            Item('threshold', springy=True),
                                            Item('n_lines', springy=True),
                                            ),
