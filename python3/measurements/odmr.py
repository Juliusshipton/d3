...
class ODMR(ManagedJob, GetSetItemsMixin):
    ...
    traits_view = View(VGroup(HGroup(Item('submit_button', show_label=False, springy=True),
                                     Item('remove_button', show_label=False, springy=True),
                                     Item('resubmit_button', show_label=False, springy=True),
                                     Item('priority', enabled_when='state != "run"', springy=True),
                                     Item('state', style='readonly', springy=True),
                                     Item('run_time', style='readonly', format_str='%.f', springy=True),
                                     Item('stop_time', springy=True),
                                     ),
                              VGroup(HGroup(Item('power', width='40ch', enabled_when='state != "run"', springy=True),
                                            Item('frequency_begin', width='80ch', enabled_when='state != "run"', springy=True),
                                            Item('frequency_end', width='80ch', enabled_when='state != "run"', springy=True),
                                            Item('frequency_delta', width='80ch', enabled_when='state != "run"', springy=True),
                                            ),
                                     HGroup(Item('pulsed', enabled_when='state != "run"', springy=True),
                                            Item('power_p', width='40ch', enabled_when='state != "run"', springy=True),
                                            Item('frequency_begin_p', width='80ch', enabled_when='state != "run"', springy=True),
                                            Item('frequency_end_p', width='80ch', enabled_when='state != "run"', springy=True),
                                            Item('frequency_delta_p', width='80ch', enabled_when='state != "run"', springy=True),
                                            Item('t_pi', width='50ch', enabled_when='state != "run"', springy=True),
                                            ),
                                     HGroup(Item('seconds_per_point', width='40ch', enabled_when='state != "run"', springy=True),
                                            Item('laser', width='50ch', enabled_when='state != "run"', springy=True),
                                            Item('wait', width='50ch', enabled_when='state != "run"', springy=True),
                                            ),
                                     HGroup(Item('perform_fit', springy=True),
                                            Item('number_of_resonances', width='60ch', springy=True),
                                            Item('threshold', width='60ch', springy=True),
                                            Item('n_lines', width='60ch', springy=True),
                                            ),
                                     HGroup(Item('fit_contrast', style='readonly', springy=True),
                                            Item('fit_line_width', style='readonly', springy=True),
                                            Item('fit_frequencies', style='readonly', springy=True),
                                            ),
                                     ),
                              VSplit(Item('matrix_plot', show_label=False, resizable=True, springy=True),
                                     Item('line_plot', show_label=False, resizable=True, springy=True),
                                     ),
                              ),
                       menubar=MenuBar(Menu(Action(action='saveLinePlot', name='SaveLinePlot (.png)'),
                                              ...
                                              name='File')),
                       title='ODMR', width='900ch', height=800, buttons=[], resizable=True, handler=ODMRHandler
                       )
