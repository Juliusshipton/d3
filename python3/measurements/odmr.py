...
class ODMR(ManagedJob, GetSetItemsMixin):
    ...
    traits_view = View(VGroup(HGroup(Item('submit_button', show_label=False, springy='left'),
                                     Item('remove_button', show_label=False, springy='left'),
                                     Item('resubmit_button', show_label=False, springy='left'),
                                     Item('priority', enabled_when='state != "run"', springy='left'),
                                     Item('state', style='readonly', springy='left'),
                                     Item('run_time', style='readonly', format_str='%.f', springy='left'),
                                     Item('stop_time', springy='left'),
                                     ),
                              VGroup(HGroup(Item('power', width= -40, enabled_when='state != "run"', springy='left'),
                                            Item('frequency_begin', width= -80, enabled_when='state != "run"', springy='left'),
                                            Item('frequency_end', width= -80, enabled_when='state != "run"', springy='left'),
                                            Item('frequency_delta', width= -80, enabled_when='state != "run"', springy='left'),
                                            ),
                                     HGroup(Item('pulsed', enabled_when='state != "run"', springy='left'),
                                            Item('power_p', width= -40, enabled_when='state != "run"', springy='left'),
                                            Item('frequency_begin_p', width= -80, enabled_when='state != "run"', springy='left'),
                                            Item('frequency_end_p', width= -80, enabled_when='state != "run"', springy='left'),
                                            Item('frequency_delta_p', width= -80, enabled_when='state != "run"', springy='left'),
                                            Item('t_pi', width= -50, enabled_when='state != "run"', springy='left'),
                                            ),
                                     HGroup(Item('seconds_per_point', width= -40, enabled_when='state != "run"', springy='left'),
                                            Item('laser', width= -50, enabled_when='state != "run"', springy='left'),
                                            Item('wait', width= -50, enabled_when='state != "run"', springy='left'),
                                            ),
                                     HGroup(Item('perform_fit', springy='left'),
                                            Item('number_of_resonances', width= -60, springy='left'),
                                            Item('threshold', width= -60, springy='left'),
                                            Item('n_lines', width= -60, springy='left'),
                                            ),
                                     HGroup(Item('fit_contrast', style='readonly', springy='left'),
                                            Item('fit_line_width', style='readonly', springy='left'),
                                            Item('fit_frequencies', style='readonly', springy='left'),
                                            ),
                                     ),
                              VSplit(Item('matrix_plot', show_label=False, resizable=True, springy='left'),
                                     Item('line_plot', show_label=False, resizable=True, springy='left'),
                                     ),
                              ),
