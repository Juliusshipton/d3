...
COTask.co_channels.add_co_pulse_chan_freq(
    ...
    duty_cycle=50 # Is the width of the pulse divided by the pulse period. NI-DAQmx uses this ratio combined with frequency to determine pulse width and the interval between pulses.
    )
